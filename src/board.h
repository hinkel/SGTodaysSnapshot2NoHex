...
typedef enum
{
    ...
    FEATURE_GRAUPNERSUMH     = 1 << 4,
    FEATURE_MOTOR_STOP       = 1 << 5,
    FEATURE_SERVO_TILT       = 1 << 6,
    FEATURE_LED              = 1 << 7,
    FEATURE_GPS              = 1 << 8,
    FEATURE_FAILSAFE         = 1 << 9,
    FEATURE_SONAR            = 1 << 10,
    FEATURE_PASS             = 1 << 11,                     // Crashpilot Passthrough
    FEATURE_LCD              = 1 << 12,                     // Crashpilot LCD Display
} AvailableFeatures;
...
{
    uint16_t ut_delay;
    uint16_t up_delay;                                      // Not Used    uint16_t repeat_delay;
